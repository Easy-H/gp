...
function GenericPanelLayoutComponent<T>(
  ...
  return (
    <div className="generic-panel-container" style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', flex: 1, overflow: 'hidden', position: 'relative', backgroundColor: colors.background, boxSizing: 'border-box' }}>
      <Group 
