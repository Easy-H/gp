...
export function PanelGroup<T>({
  ...
  dragOverPos, dropZone, onPanelDragOver, onPanelDrop, onPanelDragLeave, onTabDragStart, onDragEnd, colors
}: PanelGroupProps<T>) {
  ...
  return (
    <div
      style={{ 
        ...
        backgroundColor: colors.box, border: 'none', position: 'relative',
    ...
    >
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                  <button
                    ...
                    style={{ background: 'none', border: 'none', color: colors.text, cursor: 'pointer', padding: '2px', fontSize: '10px', opacity: 0.6 }}
                  >✕</button>
                </div>
              </div>
            );
        ...
        {onAddItem && (
          <div
            ...
            style={{
              ...
              borderLeft: `1px solid ${colors.surface}`,
              color: colors.text,
              opacity: 0.6,
              fontSize: '16px',
              userSelect: 'none',
      ...
      <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
        ...
        {dragOverPos?.cIdx === cIdx && dragOverPos?.rIdx === rIdx && dropZone && (
          <DropOverlay zone={dropZone} colors={colors} />
        )}
      </div>
    </div>
  );
...
function DropOverlay({ zone, colors }: { zone: string; colors: PanelLayoutColors }) {
