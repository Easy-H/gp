...
export const ResizeHandle: React.FC<ResizeHandleProps> = ({ direction, colors }) => {
  ...
  return (
    <Separator
      ...
      style={{
        ...
        zIndex: 100, // 탭 바(100)보다 확실히 높게 설정하여 터치/클릭 차단 방지
        outline: 'none',
    ...
    >
      <div style={{
        ...
        backgroundColor: isHovered ? colors.primary : '',
