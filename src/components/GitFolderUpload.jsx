...
const GitFolderUpload = ({ onUpload, onRemoteAnalyze, gitUrl, setGitUrl, isProcessing, processingStatus }) => {
  ...
  return (
    <div style={{ padding: '30px', border: '2px dashed var(--panel-border)', borderRadius: '8px', textAlign: 'center', backgroundColor: 'var(--panel-bg-2)', color: 'var(--panel-text)', display: 'flex', flexDirection: 'column', gap: '20px' }}>
      {/* 원격 저장소 섹션 */}
      <div>
      ...
      <hr style={{ width: '100%', border: '0', borderTop: '1px solid var(--panel-border)' }} />
      ...
      {isProcessing && processingStatus && (
        <div style={{ marginTop: '10px' }}>
          <div style={{ marginBottom: '5px', fontSize: '14px', color: 'var(--panel-muted)' }}>
            {processingStatus.fileName}
          </div>
          <div style={{ width: '100%', backgroundColor: 'var(--panel-border)', borderRadius: '10px', height: '10px' }}>
            <div 
              style={{ 
